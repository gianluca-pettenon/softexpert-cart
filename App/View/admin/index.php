            ...
            <div class="modal-body">
                ...
                <form method="POST" id="formType">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="form-group mb-2">
                                <label for="txtTypeName" class="form-label fw-bold mt-4">PRODUTO <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="txtTypeName" maxlength="100">
                            </div>
                        </div>

                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="txtTypeTax" class="form-label fw-bold mt-4">PERC. DO IMPOSTO <span class="text-danger">*</span></label>
                                <div class="input-group mb-2">
                                    <span class="input-group-text">%</span>
                                    <input type="text" class="form-control" id="txtTypeTax">
                                </div>
                            </div>
                        </div>
